...
<script src="{{ asset('js/jquery-datatable.min.js') }}"></script>
  ...
  <body class="g-sidenav-show  bg-gray-100">
    ...
    <span class="ms-1 font-weight-bold text-white">Point Of Sales</span>
    </a>
    </div>
        {{-- Sidenav header End --}}
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item mb-2 mt-0">
        ...
        <div class="collapse" id="ProfileNav" style="">
          <ul class="nav ">
            <li class="nav-item">
              <a class="nav-link text-white" href="{{ url('/user/user-profile') }}">
    ...
    <li class="nav-item active">
      <a class="nav-link text-white active" href="{{ url('/category-page') }}">
    ...
    <div class="collapse " id="dashboardsExamples">
        ...
        <li class="nav-item ">
          <a class="nav-link text-white active" href="{{ url('/customer-page') }}">
            <span class="sidenav-mini-icon"> B </span>
            <span class="sidenav-normal  ms-2  ps-1"> Customer List </span>
          </a>
        </li>
        </ul>
    </div>
